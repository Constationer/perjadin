        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="@if($active == 'Dashboard') active @endif">
              <a href="{{ route('dashboard.index') }}" class="nav-link"><i class="fas fa-desktop"></i> <span>Dashboard</span></a>
            </li>
            <li class="menu-header">Data</li>
            <li class="@if($active == 'OPD') active @endif"><a class="nav-link" href="{{ route('Opd.index') }}"><i class="far fa-building"></i> <span>OPD</span></a></li>
            <li class="@if($active == 'Pegawai') active @endif"><a class="nav-link" href="{{ route('Pegawai.index') }}"><i class="far fa-user"></i> <span>Pegawai</span></a></li>
            <li class="@if($active == 'SPJ') active @endif"><a class="nav-link" href="{{ route('Spj.index') }}"><i class="far fa-envelope"></i> <span>SPJ</span></a></li>
            {{-- <li class="dropdown">
